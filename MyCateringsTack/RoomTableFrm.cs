...
namespace MyCateringsTack
{
    public partial class RoomTableFrm : UITitlePage
    {
        ...
        private void uiButton1_Click(object sender, System.EventArgs e)
        {
            ...
            rt.MinConst = (int)uiDataGridView1.Rows[index].Cells["minConst"].Value;
        ...
        private void uiButton4_Click(object sender, System.EventArgs e)
        {
            ...
            {
                UIMessageTip.ShowError("请选择要修改行数据！");
                return;
            }

            UpdateTable up = new UpdateTable();
            Tables t = new Tables();
            int id = (int)uiDataGridView2.SelectedRows[0].Cells["sb"].Value;
        ...
        private void uiButton5_Click(object sender, System.EventArgs e)
        {
            ...
            int index = (int)uiDataGridView2.SelectedRows[0].Cells["sb"].Value; //(int)uiDataGridView2.SelectedRows[0].Cells["sb "].Value; 
